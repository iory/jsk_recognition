...
class MobileNetV2(nn.Module):
    def __init__(self, in_channels, n_class=1000, width_mult=1.0):
        ...
        # assert input_size % 32 == 0(default=224)
...
def mobilenetv2(in_channels=3, pretrained=False, **kwargs):
    ...
    """
    model = MobileNetV2(in_channels, n_class=1000, **kwargs)
    if pretrained:
        model.load_state_dict(load_from_url(
            model_urls["mobilenetv2"]), strict=False)
    return model
