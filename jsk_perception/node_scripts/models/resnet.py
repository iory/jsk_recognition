...
__all__ = ["ResNet", "resnet18", "resnet50",
           "resnet101"]  # resnet101 is coming soon!
...
def resnet18(in_channels=3, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_from_url(model_urls["resnet18"]))
    return model
...
def resnet101(in_channels=3, pretrained=False, **kwargs):
